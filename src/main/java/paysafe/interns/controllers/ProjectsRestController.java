...
/**
 * A RestController class where we define
 * the endpoint URLs for the Project service.
 * It uses Autowired annotation in order to
 * use component scan for our {@link ProjectsRepository}
 */
@RestController
public class ProjectsRestController {
    ...
    /**
     * GET
     * Serving {@link ProjectsRepository#findAll()} method
    ...
    /**
     * GET
     * Serving the {@link ProjectsRepository#findOne(Serializable)} method
    ...
    /**
     * POST
     * Serves the {@link ProjectsRepository#save(Object)} method.
     * Saves a project in the database
     * @param project the project to be saved which is passed by
     *                a json body request parameter
     * @return json string of an anonymous object holding the
