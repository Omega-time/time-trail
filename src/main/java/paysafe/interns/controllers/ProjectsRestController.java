...
public class ProjectsRestController extends BaseRestController {
     ...
     */
    @RequestMapping(value = "/projects/{projectId}/files", method = RequestMethod.POST)
    ...
    /**
     * GET for file names. Lists the names of all files currently associated
     * with the project.
     *
     * @param projectId
     ...
     *         project.
     */
    @RequestMapping(value = "/projects/{projectId}/files", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/projects/{projectId}/{fileName:.+}", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/projects/{projectId}/{fileName:.+}", method = RequestMethod.DELETE)
